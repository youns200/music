...
"""
    ...
    srtartt = "ڕێگەت پێدەدات بۆ پەخشکردنی مۆسیقا و ڤیدیۆ لەسەر گروپەکان لە ڕێگەی چاتەکانی ڤیدیۆی تەلگرامی نوێ!/n💡 هەموو فەرمانەکانی بۆت بدۆزەرەوە و چۆن کار دەکەن بە کلیک کردن لەسەر دوگمەی فەرمانەکانی 📚"
    out = private_panel()
    return await app.send_photo(
                message.chat.id,
