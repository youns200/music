...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    draw.text((27, 543), f"پەخشکراوە لە: {ctitle[:14]}...", fill= "white", stroke_width = 1, stroke_fill="white", font=font2)
    draw.text((27, 543), f"{title[:27]}...", fill="white", stroke_width = 2, stroke_fill="white" ,font=font)
